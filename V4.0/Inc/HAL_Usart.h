...
#define HAL_USART_RX_INT3_EN	EN
...
#define HAL_USART_TXE_CLEAR		 (~(1<<HAL_USART_TXE))
#define HAL_USART_RXE			 5U
#define HAL_USART_RXNE_EN        (1<<HAL_USART_RXE)
...
typedef struct
{
	...
	uint32_t Parity;
	uint32_t Mode;
#if HAL_USART_RX_INT_EN==EN || HAL_USART_RX_INT2_EN==EN || HAL_USART_RX_INT3_EN==EN
